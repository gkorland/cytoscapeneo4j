...
public final class TaskConstants {
    ...
    public static final String MATCH_ALL_NODES_AND_EDGES = "match (n)-[r]->(m) return id(n),n,r,id(m),m LIMIT 25"; //"match (n '{'" + NEO4J_PROPERTY_CYTOSCAPE_NETWORK + ":''{0}'''}')-[r*0..1]-(m '{'_cytoscape_network:''{0}'''}') RETURN n,r,m"
